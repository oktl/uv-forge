"""Application entry point for UV Forger.
...
from uv_forger.core.logging_config import setup_logging
from uv_forger.core.settings_manager import load_settings
from uv_forger.core.state import AppState
from uv_forger.handlers.ui_handler import attach_handlers
...
def run() -> None:
    """Entry point for the uv-forger console script."""
